...
const std::string BASE("ch4/ex4_1.");
...
int main()
{
    ...
    GLint uniBlend = glGetUniformLocation(shaderProgram, "blend");
    glUniform1f(uniBlend, 0.0f);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform1f(uniBlend, (std::sin(time) + 1.0f) / 2.0f);
